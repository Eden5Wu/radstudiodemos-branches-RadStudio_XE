...
type
  ...
  private
    ...
    function TransformIdentifier(AIdentifier: String): String;
...
uses
  ...
  DbxDB2, DbxOracle, // DbxSybase, DbxBlackfishSQL,
...
begin
  ...
  begin
    ...
    FieldList := FieldList + TransformIdentifier
      (CurrentName);
    ValueList := ValueList + '?';
  ...
  Result.Text := Format('INSERT INTO %s (%s) VALUES(%s)',
    ...
    [TransformIdentifier(ATableName), FieldList, ValueList]);
...
begin
  ...
  // Assemble the INSERT statement.
  TableName := TransformIdentifier(TDBXMigratorSchema.TableName(ATableSchema));
  Result.Text := Format('INSERT INTO %s (%s) VALUES(%s)',
...
function TDBXMigrator.TransformIdentifier(AIdentifier: String): String;
var
...
begin
  ...
  TempWriter := DBXGetMetaWriter(DestProvider);
